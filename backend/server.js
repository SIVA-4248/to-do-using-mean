...
const MONGODB_URI = process.env.MONGODB_URI || process.env.MONGODB_URL || process.env.MONGO_URL || process.env.DATABASE_URL || 'mongodb+srv://todouser:todopass123@cluster0.dn8spfe.mongodb.net/todoapp?appName=Cluster0';
    ...
    <head>
      ...
      <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header h1 { font-size: 2.5em; font-weight: 300; margin: 0; }
        .subtitle { margin: 10px 0 0 0; opacity: 0.9; font-size: 1.1em; }
        .add-todo { display: flex; padding: 30px; gap: 15px; background: #f8f9fa; }
        .todo-input {
          flex: 1; padding: 15px 20px; border: 2px solid #e9ecef;
          border-radius: 50px; font-size: 16px; outline: none;
        }
        .add-btn {
          padding: 15px 30px; background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%);
        ...
        .stats span { font-weight: 600; color: #495057; }
        .total { color: #6f42c1; }
        ...
        .todo-content { display: flex; align-items: center; flex: 1; gap: 15px; }
        .todo-checkbox { width: 20px; height: 20px; cursor: pointer; }
        .todo-text { flex: 1; }
        .todo-title { font-size: 16px; font-weight: 500; color: #212529; }
        .todo-item.completed .todo-title { text-decoration: line-through; color: #6c757d; }
